...
def welcome(request):
    return render(request, 'ecowiseapp/welcome.html')

@login_required
def home(request):
    return render(request, 'ecowiseapp/home.html')
...
def user_register(request):
    ...
    return render(request, 'ecowiseapp/register.html',
...
def user_login(request):
    ...
    return render(request, 'ecowiseapp/login.html',
                  {'error_message': error_message})
...
def viewNodes(request):
    try:
        ...
        return render(request, 'ecowiseapp/nodes.html', context)

    except:
        return render(request, 'ecowiseapp/nodes.html')
...
def addnode(request):
    ...
    return render(request, 'ecowiseapp/addnode.html')
...
def addcluster(request):
    ...
    return render(request, 'ecowiseapp/addcluster.html', context)
...
def viewNodeData(request):
    ...
    if Nodedata.objects.filter(node_name=nodename).exists():
        ...
        return render(request, 'ecowiseapp/nodedata.html', context)
    else:
...
def viewclusterData(request):
    ...
    if Clusterdata.objects.filter(cluster_name=clustername).exists():
        ...
        return render(request, 'ecowiseapp/clusterdata.html', context)
